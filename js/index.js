...
function sat_info() {
    $("#sat_info").empty();
    var i = 1;
    var el = "<div class= 'row'><a>Where: North Pole</a><a >Start: " + window.sat["North-Pole"]
    [i].start.day + " at " + window.sat["North-Pole"][i].start.hours + ":" + window.sat["North-Pole"][i].start.minutes + ":" + window.sat["North-Pole"][i].start.seconds + "</a><a>End: " + window.sat["North-Pole"][i].end.day + " at " + window.sat["North-Pole"][i].end.hours + ":" + window.sat["North-Pole"][i].end.minutes + ":" + window.sat["North-Pole"][i].end.seconds + " UTC time</a><a>Where: South Pole</a><a >Start: " + window.sat["South-Pole"]
    [i].start.day + " at " + window.sat["South-Pole"][i].start.hours + ":" + window.sat["South-Pole"][i].start.minutes + ":" + window.sat["South-Pole"][i].start.seconds + "</a><a>End: " + window.sat["South-Pole"][i].end.day + " at " + window.sat["South-Pole"][i].end.hours + ":" + window.sat["South-Pole"][i].end.minutes + ":" + window.sat["South-Pole"][i].end.seconds + " UTC time</a><a class='btn' id='more_sat'>Next Step</a></div>";

    $("#sat_info").html(el);
    $("#more_sat").on("click", function () {
        $("#sat_info").empty();
        i = i + 1;
        var el = "<div class= 'row'><a>Where: North Pole</a><a >Start: " + window.sat["North-Pole"]
    [i].start.day + " at " + window.sat["North-Pole"][i].start.hours + ":" + window.sat["North-Pole"][i].start.minutes + ":" + window.sat["North-Pole"][i].start.seconds + "</a><a>End: " + window.sat["North-Pole"][i].end.day + " at " + window.sat["North-Pole"][i].end.hours + ":" + window.sat["North-Pole"][i].end.minutes + ":" + window.sat["North-Pole"][i].end.seconds + " UTC time</a><a>Where: South Pole</a><a >Start: " + window.sat["South-Pole"]
    [i].start.day + " at " + window.sat["South-Pole"][i].start.hours + ":" + window.sat["South-Pole"][i].start.minutes + ":" + window.sat["South-Pole"][i].start.seconds + "</a><a>End: " + window.sat["South-Pole"][i].end.day + " at " + window.sat["South-Pole"][i].end.hours + ":" + window.sat["South-Pole"][i].end.minutes + ":" + window.sat["South-Pole"][i].end.seconds + " UTC time</a><a class='btn' id='more_sat'>Next Pass</a></div>";
        $("#sat_info").html(el);
    })

}

function artic_swal(valY, valM) {
...
function artic() {
    ...
    $("#artic_add").on("click", function () {
        var mounth_name = "January"
        artic_swal(valY, mounth_name);
...
function antartic() {
    ...
    $("#antartic_add").on("click", function () {
        var month_name = "January";
        antartic_swal(valY, month_name);
